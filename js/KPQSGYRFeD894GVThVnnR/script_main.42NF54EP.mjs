import { Fa as T, H as k, I as _, K as t, L as v, M as b, N as E, O as I, R as w, V as O, X as P, Xa as z, ca as S, d as h, f as n, ga as M, i as F, j as p, la as U, ra as N } from "./chunk-NV2CJCYN.mjs";
...
async function G(o, s) {
    try {
        ...
        o ? (z("framer-rewrite-breakpoints", () => {
            T(m),
...
(function () {
    g && p(() => {
        // f(document.getElementById("__framer-badge-container")).render(n(h, {}, n(S(M), {
        ...
        // }, n(F(() => import("./PX9hIOIVM-PER7CIDI.mjs"))))))
    }
    )
}
)();
export { A as getPageRoot };
//# sourceMappingURL=script_main.42NF54EP.mjs.map
